...
public class SearchEmployee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Employee Id", " Name", "DOB", "Sex", "Phone", "phone2", "Email", "Address", "Type Of Degree", "Graduated Year", "Department"
            }
        ));
        ...
        if(hg.equals(""))
        {
            ...
            try {
                ...
                if (jRadioButton1.isSelected() == true) {
                    ...
                    query = "Select eid from employee where fname like \"%" + str + "%\";";
                    ...
                    if (rs.next()) {
                        ...
                        for (int x = 0; x < k; x++) {
                            eid = pidf[x];
                            query = "SELECT eid, fname, dob, gender, phone, phone2, email, address, degree, gyear, department FROM employee";
                            rs4 = stmt.executeQuery(query);
                            System.out.println(""+query);
                            if (rs4.next()) {
                                model.addRow(new Object[]{"" + rs4.getInt(1), rs4.getString(2), rs4.getString(3),
                                    rs4.getString(4), rs4.getInt(5), rs4.getInt(6), rs4.getString(7), rs4.getString(8), rs4.getString(9), rs4.getInt(10), rs4.getString(11)});
                        }
                ...
                if (rs.next()) {
                    i=0;
                    query = "SELECT eid, fname, dob, gender, phone, phone2, email, address, degree, gyear, department FROM patient1";
                    rs4 = stmt.executeQuery(query);
                    System.out.println(""+query);
                    if (rs4.next()) {
                        model.addRow(new Object[]{"" + rs4.getInt(1), rs4.getString(2), rs4.getString(3),
